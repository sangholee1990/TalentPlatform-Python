...
metaData["TalentPlatform-BDWIDE2026-DaemonApi-teethSeg"]="cd /HDD/SYSTEMS/PROG/PYTHON/IDE/src/proj/bdwide/2026 && /HDD/SYSTEMS/LIB/anaconda3/envs/py39/bin/python -m uvicorn TalentPlatform-BDWIDE2026-DaemonApi-teethSeg:app --host=0.0.0.0 --port=9920"
...
metaData["TalentPlatform-BDWIDE2026-DaemonApi-bioPrd"]="cd /HDD/SYSTEMS/PROG/PYTHON/IDE/src/proj/bdwide/2026/bioPrd && /HDD/SYSTEMS/LIB/anaconda3/envs/py311/bin/python -m uvicorn TalentPlatform-BDWIDE2026-DaemonApi-bioPrd:app --host=0.0.0.0 --port=9930"
metaData["TalentPlatform-BDWIDE2026-DaemonApi-chatTrouShoot"]="cd /HDD/SYSTEMS/PROG/PYTHON/IDE/src/proj/bdwide/2026/trouShoot && /HDD/SYSTEMS/LIB/anaconda3/envs/py311/bin/python -m uvicorn TalentPlatform-BDWIDE2026-DaemonApi-chatTrouShoot:app --host=0.0.0.0 --port=9940"
metaData["TalentPlatform-BDWIDE2026-streamlit-bioPrd"]="cd /HDD/SYSTEMS/PROG/PYTHON/IDE/src/proj/bdwide/2026/bioPrd && /HDD/SYSTEMS/LIB/anaconda3/envs/py311/bin/python -m streamlit run TalentPlatform-BDWIDE2026-streamlit-bioPrd.py --server.port 9931"
#metaData["llama-server"]="export LD_LIBRARY_PATH=/HDD/SYSTEMS/LIB/anaconda3/envs/py311/lib:$LD_LIBRARY_PATH && cd /HDD/SYSTEMS/PROG/PYTHON/IDE/src/proj/bdwide/2026/trouShoot/llama-b10502 && /HDD/SYSTEMS/PROG/PYTHON/IDE/src/proj/bdwide/2026/trouShoot/llama-b10502/llama-server -m "/HDD/DATA/INPUT/BDWIDE2026/chatTrouShoot/ollama/gemma-4-E2B-it-Q4_K_M.gguf" --mmproj "/HDD/DATA/INPUT/BDWIDE2026/chatTrouShoot/ollama/mmproj-F16.gguf" --host 0.0.0.0 --port 9941 -ngl 999 -c 4096 --parallel 2 -fa on -rea off"
metaData["llama-server"]="export LD_LIBRARY_PATH=/HDD/SYSTEMS/LIB/anaconda3/envs/py311/lib:$LD_LIBRARY_PATH && cd /HDD/SYSTEMS/PROG/PYTHON/IDE/src/proj/bdwide/2026/trouShoot/llama-b10502 && /HDD/SYSTEMS/PROG/PYTHON/IDE/src/proj/bdwide/2026/trouShoot/llama-b10502/llama-server -m "/HDD/DATA/INPUT/BDWIDE2026/chatTrouShoot/ollama/gemma-4-E2B-it-Q4_K_M.gguf" --host 0.0.0.0 --port 9941 -ngl 999 -c 4096 --parallel 2 -fa on -rea off"
