...
def setPrdDataDB(cfgInfo, dbData):
    ...
    try:
        ...
        for k, dbInfo in dbData.iterrows():
            ...
            session.execute(
                """
                INSERT INTO `{}` (SRV, ANA_DATE, DATE_TIME, DATE_TIME_KST, CA_TOT, HM, PA, TA, TD, WD, WS, SZA, AZA, ET, TURB, GHI_CLR, DNI_CLR, DHI_CLR, GHI_POA, DNI_POA, DHI_POA, SWR, REG_DATE, MOD_DATE, ML2, DL2)
                VALUES ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')
                ON DUPLICATE KEY UPDATE
                    DATE_TIME_KST = VALUES(DATE_TIME_KST), CA_TOT = VALUES(CA_TOT), HM = VALUES(HM), PA = VALUES(PA), TA = VALUES(TA)
                    , TD = VALUES(TD), WD = VALUES(WD), WS = VALUES(WS), SZA = VALUES(SZA), AZA = VALUES(AZA), ET = VALUES(ET)
                    , GHI_CLR = VALUES(GHI_CLR), DNI_CLR = VALUES(DNI_CLR), DHI_CLR = VALUES(DHI_CLR), GHI_POA = VALUES(GHI_POA)
                    , DNI_POA = VALUES(DNI_POA), DHI_POA = VALUES(DHI_POA), SWR = VALUES(SWR), MOD_DATE = VALUES(MOD_DATE)
                    , ML2 = VALUES(ML2), DL2 = VALUES(DL2)
                    ;
                    """.format(selDbTable
                               , dbInfo['SRV'], dbInfo['ANA_DATE'], dbInfo['DATE_TIME'], dbInfo['DATE_TIME_KST']
                               , dbInfo['CA_TOT'], dbInfo['HM'], dbInfo['PA'], dbInfo['TA']
                               , dbInfo['TD'], dbInfo['WD'], dbInfo['WS'], dbInfo['SZA'], dbInfo['AZA'], dbInfo['ET']
                               , dbInfo['TURB'], dbInfo['GHI_CLR'], dbInfo['DNI_CLR']
                               , dbInfo['DHI_CLR'], dbInfo['GHI_POA'], dbInfo['DNI_POA'], dbInfo['DHI_POA']
                               , dbInfo['SWR'], dbInfo['REG_DATE'], dbInfo['MOD_DATE']
