...
class DtaProcess(object):
    ...
    def exec(self):
        ...
        try:
            ...
            # inpFile = '{}/{}/{}'.format(globalVar['inpPath'], serviceName, 'exp9/20230504_output.mp4')
            ...
            for i, fileInfo in enumerate(fileList):
                ...
                dataL3 = procFile(dataL3, 'NEW-cnt', 'NEW-info', 'object_tracking*/labels/{}_{}.txt', serviceName, fileNameNoExt)
