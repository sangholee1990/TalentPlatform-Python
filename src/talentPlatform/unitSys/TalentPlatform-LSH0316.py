...
class DtaProcess(object):
    ...
    def exec(self):
        ...
        try:
            ...
            # 파일 찾기
            inpFile = '{}/{}/{}'.format(globalVar['inpPath'], serviceName, '고령인구비율.csv')
            ...
            plot = (
                    ...
                    labs(title='행정구역에 따른 고령인구비율 분포', xlab='행정구역', ylab='고령 인구 비율 [%]') +
                    theme(
            ...
            plot = (
                    ...
                    geom_point() +
                    # coord_flip() +
                    labs(title='월별 행정구역에 따른 고령인구비율 분포', xlab='날짜 [년-월}', ylab='고령 인구 비율 [%]') +
