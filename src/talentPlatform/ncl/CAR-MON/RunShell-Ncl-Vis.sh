...
cat ${CFG_PATH}/TEMPLATE-CAR-MON.ncl |
  sed -e "s:%fileInfo:${fileInfo}:g" \
    ...
    -e "s:%var:val:g" \
    -e "s:%saveImg:${saveImg}:g" > ${RUN_PATH}/20220925.ncl

ncl ${RUN_PATH}/20220925.ncl
