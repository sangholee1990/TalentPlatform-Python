...
parser.add_argument('--PNG_DIR', type=str, required=False, default='C:\SYSTEMS\PROG\PYTHON\climate_extremes\gk2a_sst\output\gk2a_ami_le3_sst01m_ea020lc_202606010000.png')
...
# 2026.05.29 수정
# pcm = m.pcolormesh(x,y,data,cmap='jet', shading='auto', vmin=0, vmax=35)
