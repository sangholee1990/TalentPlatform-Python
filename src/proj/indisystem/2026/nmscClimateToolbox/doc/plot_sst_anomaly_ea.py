...
# parser.add_argument('--PNG_DIR', type=str, required=False, default='C:\SYSTEMS\PROG\PYTHON\climate_extremes\gk2a_sst\output\gk2a_ami_le3_sst01m-anom_ea020lc_202606010000.png')
...
parser.add_argument('--PNG_DIR', type=str, required=False, default='C:\SYSTEMS\PROG\PYTHON\climate_extremes\gk2a_sst\output\gk2a_ami_le3_sst01m-diff_eq020lc_202606010000.png')
...
# NC_DIR = f"{CTX_DIR}/output/{args.NC_DIR}"
# PNG_DIR =  f"{CTX_DIR}/output/{args.PNG_DIR}"
NC_DIR = args.NC_DIR
...
# CTX_PATH = "C:\SYSTEMS\PROG\PYTHON\climate_extremes\gk2a_sst"
# NC_DIR = f"{CTX_DIR}/output/gk2a_ami_le3_sst01m-anom_ea020lc_202511010000.nc"
# PNG_DIR = f"{CTX_DIR}/output/gk2a_ami_le3_sst01m-anom_ea020lc_202511010000.png"
