...
parser.add_argument('--PNG_DIR', type=str, required=False, default='C:\SYSTEMS\PROG\PYTHON\climate_extremes\gk2a_sst\output\gk2a_ami_le3_sst01m_ko020lc_202606010000.png')
...
labels = plt.clabel(c, inline=True, fontsize=10, fmt='%d', colors='black')
# labels = plt.clabel(c, inline=True, fontsize=10, fmt='%d', colors='black', manual=manual_locs)
for label in labels:
