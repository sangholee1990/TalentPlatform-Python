...
# 프로그램 종료
# ps -ef | grep python | grep TalentPlatform-QUBE2025-repro.py | awk '{print $2}' | xargs kill -9
# pkill -f TalentPlatform-QUBE2025-repro.py
    ...
    try:
        with cfgDb['sessionMake']() as session:
            query = text("""
                         ...
                         FROM tb_pv_data;
                         """)
            cfgData = pd.DataFrame(session.execute(query))
