                ...
                with cfgDb['sessionMake']() as session:
                    with session.begin():
                        ...
                        try:
                            ...
                            tmpData = prdData[xCol].copy()
                            tmpData.columns = [c.upper() for c in tmpData.columns]
                            ...
                            if resOrgPycaret:
                                ...
                                prdVal = exp.predict_model(resOrgPycaret['mlModel'], data=tmpData)['prediction_label']
                            ...
                            if resOrgH2o:
                                ...
                                prdVal = resOrgH2o['mlModel'].predict(h2o.H2OFrame(tmpData)).as_data_frame()
                            ...
                            if resLgb:
                                ...
                                prdVal = resLgb['mlModel'].predict(data=tmpData)
                            ...
                            if resFlaml:
                                ...
                                prdVal = resFlaml['mlModel'].predict(tmpData)
