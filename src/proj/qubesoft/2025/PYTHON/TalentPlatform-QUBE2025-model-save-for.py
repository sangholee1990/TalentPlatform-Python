...
# 프로그램 종료
# ps -ef | grep python | grep TalentPlatform-QUBE2025-model-save-for.py | awk '{print $2}' | xargs kill -9
# pkill -f TalentPlatform-QUBE2025-model-save-for.py

# 프로그램 시작
# conda activate py39

# cd /SYSTEMS/PROG/PYTHON
# /SYSTEMS/LIB/anaconda3/envs/py39/bin/python TalentPlatform-QUBE2025-model-save-for.py
# nohup /SYSTEMS/LIB/anaconda3/envs/py39/bin/python TalentPlatform-QUBE2025-model-save-for.py &

# 20,50 * * * * cd /SYSTEMS/PROG/PYTHON && /SYSTEMS/LIB/anaconda3/envs/py38/bin/python /SYSTEMS/PROG/PYTHON/TalentPlatform-QUBE2025-model-save-for.py
