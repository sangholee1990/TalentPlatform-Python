        ...
        try:
            ...
            for i, posInfo in posDataL1.iterrows():
                with cfgDb['sessionMake']() as session:
                    ...
                    features = ['srad', 'month', 'hour', 'dayofweek', 'trad', 'otemp', 'ptemp']
                    # features = ['srad', 'trad', 'otemp', 'ptemp']
                    ...
                    dataL3 = dataL2[dataL2['ai_ano'] == 1].sort_values(by='ai_ano_score', ascending=False)
