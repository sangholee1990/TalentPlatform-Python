...
# 프로그램 종료
# ps -ef | grep python | grep TalentPlatform-QUBE2025-realKimg.py | awk '{print $2}' | xargs kill -9
# pkill -f TalentPlatform-QUBE2025-realKimg.py
        ...
        try:
            ...
            sysOpt = {
                ...
                'KIMG': {
                    ...
                    'cfgUmFile': '/DATA/MODEL/202603/21/KIMG_r030_unis_H01_202603210000.grb2',
